...
@section('content')
			  ...
			  <form action="{{route('modifyProfile')}}" id="formUserinfo" method="POST">
				...
				<div class="user-info card p-2">
					...
					<div class="top-user-info">
						...
						<h4>
							<p for="">Nom : </p>
							<input type="text" value="{{$user->nom}}" placeholder="Votre nom" class="form-control" name="nom">
							<p for="">Prenom : </p>
							<input type="text" value="{{$user->prenom}}" placeholder="Votre prenom" class="form-control" name="prenom">
						</h4>
					</div>
	...
	<div class="loading">			
		<svg width="80px"  height="80px"  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid" class="lds-infinity" style="background: none;">
				<path fill="none"   d="M24.3,30C11.4,30,5,43.3,5,50s6.4,20,19.3,20c19.3,0,32.1-40,51.4-40 C88.6,30,95,43.3,95,50s-6.4,20-19.3,20C56.4,70,43.6,30,24.3,30z" stroke="#ffff" stroke-width="2" stroke-dasharray="2.5658892822265624 2.5658892822265624">
				<animate attributeName="stroke-dashoffset" calcMode="linear" values="0;256.58892822265625" keyTimes="0;1" dur="0.2" begin="0s" repeatCount="indefinite"></animate>
				</path>
		</svg>
		<h4>Chargement....</h4>
	</div>
